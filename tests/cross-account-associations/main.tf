...
module "ram_share" {
  source = "git::https://github.com/plus3it/terraform-aws-tardigrade-ram-share.git?ref=4.1.0"
  providers = {
    aws = aws.owner
  }
...
module "ram_share_accepter" {
  source = "git::https://github.com/plus3it/terraform-aws-tardigrade-ram-share.git//modules/cross_account_principal_association?ref=4.1.0"
...
module "vpc_member" {
  source = "git::https://github.com/terraform-aws-modules/terraform-aws-vpc.git?ref=v5.18.0"

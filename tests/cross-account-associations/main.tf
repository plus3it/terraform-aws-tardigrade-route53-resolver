...
module "ram_share" {
  source = "git::https://github.com/plus3it/terraform-aws-tardigrade-ram-share.git?ref=5.0.0"
  providers = {
    aws = aws.owner
  }
...
module "ram_share_accepter" {
  source = "git::https://github.com/plus3it/terraform-aws-tardigrade-ram-share.git//modules/cross_account_principal_association?ref=5.0.0"
...
module "vpc_owner" {
  source = "git::https://github.com/terraform-aws-modules/terraform-aws-vpc.git?ref=v6.7.0"
  providers = {
    aws = aws.owner
  }
